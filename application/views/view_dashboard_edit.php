    ...
    <div class="main-content">
      <div class="container">
        <div class="span6 addclient">
          <?php 
                if(!empty($client)) { 
                  if ($client->num_rows() > 0) { $rc=$client->row(); }
               ?>
          <form class="form-horizontal" action='<?php echo base_url(); ?>dashboard/save_updated_client/<?php echo $rc->kode_konsumen; ?>' method="POST">
            <fieldset>
              <div id="legend">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" id="nama" name="nama" placeholder="nama" class="input-xlarge" required="" value="<?php echo $rc->nama_konsumen; ?>">
                </div>
              </div>
              <!-- alamat -->
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" id="alamat" name="alamat" placeholder="JL. KaliGawe No. 5" class="input-xlarge" required="" value="<?php echo $rc->alamat; ?>">
                </div>
              </div>
              <!-- kecamatan -->
              <div class="control-group">
                    ...
                    <?php 
                      if (!empty($kec_list)) {
                        foreach ($kec_list->result() as $row) : 
                          if ($row->kode_kecamatan == $rc->kode_kecamatan) { ?>
                            <option value="<?php echo $row->kode_kecamatan; ?>" selected><?php echo $row->nama_kecamatan; ?></option>
                          <?php
                          } else {
                          ?>
                    ...
                    <?php 
                      if (!empty($jenis_list)) {
                        foreach ($jenis_list->result() as $row) : 
                          if ($row->kode_jenis == $rc->jenis) { ?>
                            <option value="<?php echo $row->kode_jenis; ?>" selected><?php echo $row->nama_jenis; ?></option>
                          <?php
                          } else {
                          ?>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <div class="input-append">
                    <input class="span1" type="text" id="kebair" name="kebair" placeholder="100" required="" value="<?php echo $rc->kebutuhan_air; ?>"><span class="add-on">m<sup>3</sup></span>
                  </div>
                </div>
              </div>
              <!-- Okupansi -->
              <div class="control-group">
                ...
                <div class="controls">
                  <div class="input-append">
                    <input class="span1" type="text" id="okupansi" name="okupansi" placeholder="10" required="" value="<?php echo $rc->okupansi; ?>"><span class="add-on">%</span>
                  </div>
                </div>
              </div>
              <?php } ?>
